...
//	var $msg_key = '827050cac8e1b81e815793e2d53bdf74';	// 123.127.90.2 测试环境中的IP验证
	...
	public function sendMessage($mobile, $msg, $key = '14f0f5b1366026fd727c58bdc8393e4b')
	{
		...
		$msg_url = 'http://utility.yoka.com/smssend/sms/SendMore.aspx?key='.$key.'&action=mt&sn=SDK-BBX-010-06057&mobile='.$mobile.'&content='.urlencode($msg);
		Debug::log('sendMessage_URL', $msg_url);
