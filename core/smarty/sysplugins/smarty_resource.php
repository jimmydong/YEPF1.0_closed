...
abstract class Smarty_Resource
{
    ...
    protected function buildFilepath(Smarty_Template_Source $source, Smarty_Internal_Template $_template=null)
    {
        ...
        if ($_template && $_template->parent instanceof Smarty_Internal_Template && $_file_is_dotted) {
            ...
            //hack by jimmy.dong@gmail.com 2014.4.22 
            if($_template->smarty->joined_template_dir) $file = $_template->smarty->joined_template_dir . DS . $file;
            else $file = dirname($_template->parent->source->filepath) . DS . $file;
